...
public class FileController {
    ...
    @EasyLog(module = "Admin-获取上传文件信息", tenant = "{getClientIP{0}}", type = OperateType.SELECT, success = "",
            fail = "{{#_errMsg}}", detail = "fileType: {{#fileType}}, filename: {{#filename}}")
    ...
    public ResponseData<UploadInfo> getUploadInfo(@ApiParam(value = "文件类型", required = true)
                                                  ...
                                                  @ApiParam(value = "文件名称，包含扩展名，例如：xxx.jpg", required = true)
