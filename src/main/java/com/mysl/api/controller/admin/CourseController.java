...
public class CourseController {
    ...
    @ApiOperation("查询课程列表")
    @EasyLog(module = "Admin-查询课程列表", tenant = "{getClientIP{0}}", type = OperateType.SELECT, success = "", fail = "{{#_errMsg}}")
    @GetMapping
    ...
    @ApiOperation("添加课程")
    @EasyLog(module = "Admin-添加课程", tenant = "{getClientIP{0}}", type = OperateType.ADD, success = "", fail = "{{#_errMsg}}", detail = "{{#dto.toString()}}")
    @PostMapping
    ...
    @ApiOperation("修改课程")
    @EasyLog(module = "Admin-修改课程", tenant = "{getClientIP{0}}", type = OperateType.UPDATE, bizNo = "{{#id}}", success = "", fail = "{{#_errMsg}}", detail = "{{#dto.toString()}}")
    @PutMapping("/{id}")
    ...
    @ApiOperation("删除课程")
    @EasyLog(module = "Admin-删除课程", tenant = "{getClientIP{0}}", type = OperateType.DELETE, bizNo = "{{#id}}", success = "", fail = "{{#_errMsg}}")
    @DeleteMapping("/{id}")
